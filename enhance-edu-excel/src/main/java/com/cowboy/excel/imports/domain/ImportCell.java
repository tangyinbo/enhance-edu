package com.cowboy.excel.imports.domain;
 ...
 * @Description:
 */
public class ImportCell extends BaseModel {
    ...
    private NullAble nullAble;//是否允许为空 0:允许 ,1:不允许 private Integer number;//excel对应的序列，起始0
