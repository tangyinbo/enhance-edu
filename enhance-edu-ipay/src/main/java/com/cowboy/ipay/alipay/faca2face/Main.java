package com.cowboy.ipay.alipay.faca2face;
...
import com.cowboy.ipay.alipay.tradepay.config.Configs;
import com.cowboy.ipay.alipay.tradepay.model.ExtendParams;
import com.cowboy.ipay.alipay.tradepay.model.GoodsDetail;
import com.cowboy.ipay.alipay.tradepay.model.builder.*;
import com.cowboy.ipay.alipay.tradepay.model.hb.*;
...
import com.cowboy.ipay.alipay.tradepay.service.AlipayMonitorService;
import com.cowboy.ipay.alipay.tradepay.service.AlipayTradeService;
import com.cowboy.ipay.alipay.tradepay.service.impl.AlipayMonitorServiceImpl;
import com.cowboy.ipay.alipay.tradepay.service.impl.AlipayTradeServiceImpl;
import com.cowboy.ipay.alipay.tradepay.service.impl.AlipayTradeWithHBServiceImpl;
import com.cowboy.ipay.alipay.tradepay.utils.GsonFactory;
import com.cowboy.ipay.alipay.tradepay.utils.Utils;
...
public class Main {
    ...
    public void test_trade_query() {
        ...
        String outTradeNo = "tradeprecreate15325056073281605698";
    ...
    public void test_trade_precreate() {
        ...
        String subject = "特步品牌旗舰门店当面付扫码消费";

        // (必填) 订单总金额，单位为元，不能超过1亿元
        // 如果同时传入了【打折金额】,【不可打折金额】,【订单总金额】三者,则必须满足如下条件:【订单总金额】=【打折金额】+【不可打折金额】
        String totalAmount = "4.9";
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                dumpResponse(response);
                System.out.println("-------------------------");
                GsonFactory.getGson().toJson(result.getResponse());
                System.out.println("-------------------------");
                // 需要修改为运行机器上的路径
                String filePath = String.format("F:\\ipay\\alipay\\qr-%s.png", response.getOutTradeNo());
